...
- **`docs/CONTEXT.md`**: the canonical domain glossary (translator PWA). There is no `CONTEXT.md` at the repo root and no `CONTEXT-MAP.md`; do not create them, the glossary lives in `docs/`.
